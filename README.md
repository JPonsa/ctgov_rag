...
This project combines a Knowledge Graph with an Large Language Model (LLMs) in a Retrieval Augmented Generation (RAG) system to overcome the challenges in analyzing and interpreting Clinical Trials (CTs) data.
