...
-o ./results/ReAct/trialgpt.questioner.ReAct.$MODEL_NAME.all.tsv \
-m all
...
poetry run python ./src/rag/ReAct.py -vllm $MODEL -port $PORT \
-i ./data/trialgpt.questioner.tsv \
-o ./results/ReAct/trialgpt.questioner.ReAct.$MODEL_NAME.sql_only.tsv \
-m sql_only
...
poetry run python ./src/rag/ReAct.py -vllm $MODEL -port $PORT \
-i ./data/trialgpt.questioner.tsv \
-o ./results/ReAct/trialgpt.questioner.ReAct.$MODEL_NAME.kg_only.tsv \
-m kg_only
...
# poetry run python ./src/rag/ReAct.py -vllm $MODEL -port $PORT \
# -i ./data/trialgpt.questioner.tsv \
# -o ./results/ReAct/trialgpt.questioner.ReAct.$MODEL_NAME.cypher_only.tsv \
# -m cypher_only
...
poetry run python ./src/rag/ReAct.py -vllm $MODEL -port $PORT \
-i ./data/trialgpt.questioner.tsv \
-o ./results/ReAct/trialgpt.questioner.ReAct.$MODEL_NAME.llm_only.tsv \
-m llm_only
